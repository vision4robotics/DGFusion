...
1. Download the pretrained model from [Google Drive](https://drive.google.com/drive/folders/1x_47Vsu_DeYh_ki8FK8shkp1m3KK8ylV?usp=drive_link) or [Baidu](https://pan.baidu.com/s/1akrP2ymDDNRUCzVqcad9Mg?pwd=stdd) and put it in the `pretrained_model` folder.
